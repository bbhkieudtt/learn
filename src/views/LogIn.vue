<template>
  <div class="text-center">
    <main
      class="bg-login fixed z-0 top-0 left-0 w-full h-screen gradient-custom pt-20"
    >
      <div class="flex z-50 px-20 justify-between">
        ...
        <div class="fixed bottom-4 text-sm right-10 z-10">
          <div class="flex justify-between items-center">
            <ul
              class="flex gap-5 text-black px-4 py-2.5 items-center rounded-lg drop-shadow-sm mt-3"
            >
